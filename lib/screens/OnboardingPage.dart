...
class OnboardingPage extends StatelessWidget {
  ...
  final data = [
    ...
    CardPlanetData(
      ...
      image: const AssetImage("assets/images/mats.png"),
    ...
    CardPlanetData(
      ...
      image: const AssetImage("assets/images/egreso.png"),
      backgroundColor: Color.fromARGB(255, 7, 138, 186),
      titleColor: Color.fromARGB(255, 59, 255, 170),
      subtitleColor: Color.fromARGB(255, 231, 10, 201),
      background: LottieBuilder.asset("assets/animation/bg-3.json"),
    ),
    CardPlanetData(
      ...
      image: const AssetImage("assets/images/carrera.png"),
